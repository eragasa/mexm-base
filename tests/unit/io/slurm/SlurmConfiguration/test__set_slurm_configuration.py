...
def dev__set_slurm_configuration__with_args():
    ...
    print(
        'type(slurm_configuration.slurm_configuration):{}'.format(
...
def test__set_slurm_configuration__with_args():
    o = SlurmConfiguration()
    o.set_slurm_configuration(
        job_name='default_job',
        qos='phillpot-b',
...
def test__set_slurm_configuration__with_kwargs():
    o = SlurmConfiguration()
    o.set_slurm_configuration(**slurm_configuration_dict)
